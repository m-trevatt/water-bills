# Since April 2025, our water bills have gone up by roughly {{compound_combined}}%.
...
In April 2025, the average combined household bill rose by {{prev_rise}}%[^2] and in April 2026, a further {{current_rise}}% was added on top[^2]. 

::rates-table::

> For an average Southern Water household, their bill rose from £{{baseline_bill}} to about £{{current_bill}} ({{compound_combined}}%). 

> For households that only take water supply, the two-year compound is nearer to {{compound_water_only}}%[^2].
...
In 2021, majority ownership of the group moved to a consortium of investment funds managed by Macquarie Asset Management. Between 2021 and 2023, those funds injected £1.65 billion of new equity into the group[^7].

Of that £1.65 billion, about £905 million reached the water company itself (the part that owns the pipes and holds the licence from the regulator). The remaining £745 million stayed at the holding companies that sit above the water company[^8].

Southern Water hasn't paid its owners a dividend since 2017[^7]. Under the terms of its licence, it also can't send cash up to the holding companies above it until its financial position recovers.
...
- A decade of flat bills
- A front-loaded, real-terms rise of roughly 48%
- An appeal adding another 2.5%
- A consumer rebate that quietly ran out in the same month
